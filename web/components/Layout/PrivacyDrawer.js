                  ...
                  <DrawerBody>
                    ...
                    <Text fontSize='sm' color='white'>
                        This website does not handle the form using a backend. The data from the form gets processed by the <Badge fontSize='xs' variant='subtle' colorScheme='pink'>EmailJS</Badge> package
                         and after reformatting it, sent to my email inbox. You can read further about how EmailJS processed your data by pressing the button below and being redirected to their privacy policy page
